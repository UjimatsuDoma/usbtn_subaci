...
- Milestone: All functionalities of the original website, plus improved app architecture.  [Nov. 24, 2024 - TBA]
    ...
    - Milestone 3: Re-arrange pages - merge All Voices screen and Categories screen, and implement Settings screen [Jan. 1, 2025 ~ Feb. 26, 2025]
      ...
      - Revision 3: Optimize font management by utilizing 7-Zip ~and `fonttools` libraries~ Leave that for a separate repo [Nov. 4, 2025 ~ TBA]  
        [Note: for bad performance of variable-to-static conversion, PRE_OREO builds will not be actively maintained in the future.]
