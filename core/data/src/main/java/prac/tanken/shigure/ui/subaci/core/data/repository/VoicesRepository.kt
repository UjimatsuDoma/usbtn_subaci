...
class VoicesRepository @Inject constructor(
    @param:VoicesGroupedByJson val voicesGroupedByJson: Json,
    @param:VoicesDataStore val voicesDataStore: DataStore<Preferences>,
    @param:DailyVoiceDataStore val dailyVoiceDataStore: DataStore<Preferences>
) {
