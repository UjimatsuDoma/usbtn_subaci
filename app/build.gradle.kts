plugins {
    alias(libs.plugins.subaci.application.flavor)
    alias(libs.plugins.subaci.resource.task.configuration)
...
dependencies {
    // Child modules
    implementation(project(":theme:fonts"))
    implementation(project(":theme:material"))
