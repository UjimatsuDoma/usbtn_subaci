package prac.tanken.shigure.ui.subaci.playlist.ui
...
import prac.tanken.shigure.ui.subaci.base.component.ErrorMessageStrip
import prac.tanken.shigure.ui.subaci.base.component.InfoMessageStrip
import prac.tanken.shigure.ui.subaci.core.ui.NotoSerifJP
import prac.tanken.shigure.ui.subaci.core.ui.NotoSerifMultiLang
...
import prac.tanken.shigure.ui.subaci.playlist.model.PlaylistPlaybackIntent
import prac.tanken.shigure.ui.subaci.playlist.model.PlaylistPlaybackSettings
import prac.tanken.shigure.ui.subaci.playlist.model.PlaylistPlaybackState
import prac.tanken.shigure.ui.subaci.playlist.model.PlaylistUpsertError
import prac.tanken.shigure.ui.subaci.playlist.model.PlaylistUpsertIntent
                ...
                Box(
                    ...
                    content = {
                        val text = if (playlistsSelections.isNotEmpty()) {
                            stringResource(TankenR.string.playlist_select_playlist_content)
                        } else {
...
private fun PlaylistTopBar(
    ...
    val title = when (playbackState) {
        ...
        PlaylistPlaybackState.Loading -> stringResource(TankenR.string.loading)
        PlaylistPlaybackState.StandBy -> {
            if (!hasPlaylist) {
                stringResource(TankenR.string.playlist_no_playlists)
            } else {
        ...
        Column(
            ...
            Column(
                ...
                if (PlaylistUpsertError.NameNotChanged in state.errors) {
                    InfoMessageStrip(
                        message = stringResource(TankenR.string.playlist_upsert_info_name_not_changed),
                        modifier = Modifier.fillMaxWidth()
                    )
                }
            }
